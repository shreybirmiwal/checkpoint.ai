                    ...
                    <div class="flex flex-col justify-center flex-1 px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
                        <div class="w-full max-w-xl mx-auto lg:w-96">
                            ...
                            <div className='flex flex-row mt-5'>
                                <button class={`w-full items-center block px-10 py-3.5 text-base font-medium text-center ${!teacher ? 'bg-blue-600' : 'bg-gray-200'}`} onClick={() => setTeacher(false)}>
                                    <span class={`ml-4 ${teacher ? 'text-black' : 'text-white'} `}> Student </span>
                                </button>
                                <button class={`w-full items-center block px-10 py-3.5 text-base font-medium text-center  ${teacher ? 'bg-blue-600' : 'bg-gray-200 '}`} onClick={() => setTeacher(true)}>
                                    <span class={`ml-4 ${teacher ? 'text-white' : 'text-black '} `}> Teacher </span>
                                </button>
                            </div>
